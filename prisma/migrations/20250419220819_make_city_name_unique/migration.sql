...
-- CreateIndex
CREATE UNIQUE INDEX "pins_userId_postId_key" ON "pins"("userId", "postId");
...
-- AddForeignKey
ALTER TABLE "pins" ADD CONSTRAINT "pins_postId_fkey" FOREIGN KEY ("postId") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
